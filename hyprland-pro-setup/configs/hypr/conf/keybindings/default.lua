...
hl.bind(mainMod .. " + CTRL + P", hl.dsp.exec_cmd("wlogout"), { description = "Start Power Menu" })
...
hl.bind(mainMod .. " + CTRL + S", hl.dsp.exec_cmd("swaync-client -t -sw"), { description = "Open ML4W Sidebar widget" })
hl.bind(mainMod .. " + CTRL + C", hl.dsp.exec_cmd("swaync-client -t -sw"), { description = "Open ML4W Calendar widget" })
hl.bind(mainMod .. " + SPACE", hl.dsp.exec_cmd("~/.config/hypr/scripts/launcher.sh"), { description = "Expand statusbar and focus it for keyboard navigation" })
...
hl.bind(mainMod .. " + Tab", hl.dsp.exec_cmd("pkill -x rofi || rofi -show window"), { description = "Open Select Window Menu" })
hl.bind("CTRL + ALT + T", hl.dsp.exec_cmd("~/.config/ml4w/themes/themes.sh"), { description = "Open Select Window Menu" })

hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("~/.config/hypr/scripts/show_desktop.sh"), { description = "Show Desktop (Minimize All)" })
...
hl.bind("ALT + Tab", function() hl.dispatch(hl.dsp.window.cycle_next()); hl.dispatch(hl.dsp.window.bring_to_top()) end, { description = "Alt+Tab Switch Window" })
